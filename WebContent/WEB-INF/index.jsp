...
<style>
		tr:nth-child(odd){background: AliceBlue ;}//奇数
		tr:nth-child(even){background: #ddd;}//偶数
	</style>
<script>
...
<p style="color:red;" id="test">这是段落中的 <b>粗体</b> 文本。</p>
...
${msg}
<h1 align="center">student情報一覧</h1>
  ...
  <table id="items" >
	...
	<div id="edit_comm" class="all">
      ...
      <input id="editid" type="text" placeholder="要修改的id" id="edit_id" name="id" value="要修改的id为"/><br>
        ...
        <input id="editnote" type="text" placeholder="备注" name="note" />
