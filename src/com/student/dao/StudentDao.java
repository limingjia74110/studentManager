...
public class StudentDao {
	...
	public List<Student> queryAll() {
		String sql = "select id,name,birthday,age,score,telephone,poslnumber,address from student";
	...
	public List<Student> queryByName(String name) {
		String sql = "select id,name,birthday,age,score,telephone,poslnumber,note,address from student where name like '%" + name + "%'";
	...
	public boolean addStu(Student student) {
		String sql = "insert into student(id,name,birthday,age,score,telephone,poslnumber,address,note) values(0,?,?,?,?)";
	...
	public boolean updateStu(Student student) {
		...
		String sql = "update student set name=? ,age=?,birthday = ? ,score = ?,telephone = ?,poslnumber = ? ,address = ?  where id =，note= ?";
